...
add_filter('the_posts', array(new kafka_TableOfContents, 'the_posts'));

function kafka_toc( $atts, $content = null ){
	global $post;

	extract(shortcode_atts( array(
		'type' => 'floatright',
		'title' => __('Contents', 'kafka')
	), $atts));
