...
function kafka_theme_scripts() {
  ...
  wp_register_script( 'kafka', get_template_directory_uri() . '/assets/js/kafka.min.js', array( 'jquery' ), null, true );

  /* wp_enqueue_style( 'animate', get_template_directory_uri() . '/assets/css/animate.min.css', array(), null ); */
  /* wp_enqueue_style( 'animate', 'https://cdnjs.cloudflare.com/ajax/libs/animate.css/3.5.2/animate.min.css', array(), null ); */
  /* wp_enqueue_style( 'bootstrap', get_template_directory_uri() . '/assets/css/bootstrap.min.css', array(), null ); */
	wp_enqueue_style( 'kafka', get_template_directory_uri() . '/assets/css/kafka.min.css', array(), null );

  wp_enqueue_script( 'jquery' );
  /* wp_enqueue_script( 'popper' ); */
  /* wp_enqueue_script( 'bootstrap' ); */
  wp_enqueue_script( 'kafka' );
